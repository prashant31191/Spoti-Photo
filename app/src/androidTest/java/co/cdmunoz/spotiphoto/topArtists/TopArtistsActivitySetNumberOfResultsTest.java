...
public class TopArtistsActivitySetNumberOfResultsTest {

  @Rule
  public ActivityTestRule<TopArtistsActivity> mActivityTestRule = new ActivityTestRule<>(TopArtistsActivity.class);

  @Test
  public void topArtistsActivitySetNumberOfResultsTest() throws InterruptedException {
    ...
    ViewInteraction checkedTextView = onView(
            allOf(withId(android.R.id.text1), withText("20"),
                    childAtPosition(
    ...
    onView (withId (R.id.top_artists_list_container)).check (matches (withRecyclerViewSize (20)));
